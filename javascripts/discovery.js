var Discovery;
	...
	Discovery.parse_ = function(recv, callback, cancel_flag){
	...
	Discovery.start = function(callback, st, flag /* cancel checking description.xml or not */){
		var upnp = new UPnP();
		var self = this;
		st = !!st === false ? "urn:schemas-upnp-org:service:AVTransport:1" : st;
